    ...
    public class HattrickDatabaseInitialization : CreateDatabaseIfNotExists<Hattrick.Service.Models.HattrickContext>
    {
        protected override void Seed(HattrickContext context)
        {
            ...
            var sportGames = new List<SportGame>
            {
                ...
                new SportGame{ Team1="Partizan",Team2="Mornar", CategoryId=context.SportCategorys.Where(x=>x.CategoryName=="Basket-ball").First().Id,Value1=1.25,Value2=4.0 ,ValueX=17,Value12=1,Value1X=1.16,Value2X=3.24,TopOffer=true, TopOfferFactor=2,GameTime=DateTime.Now},
                ...
                new SportGame{ Team1="Miami",Team2="Washington", CategoryId=context.SportCategorys.Where(x=>x.CategoryName=="Basket-ball").First().Id,Value1=1.25,Value2=4.0 ,ValueX=17,Value12=1,Value1X=1.16,Value2X=3.24,TopOffer=true, TopOfferFactor=2,GameTime=DateTime.Now},
                ...
                new SportGame{ Team1="Marterer M.",Team2="Masur D", CategoryId=context.SportCategorys.Where(x=>x.CategoryName=="Tenis").First().Id,Value1=1.40,Value2=2.70 ,ValueX=1,Value12=1,Value1X=1,Value2X=1,TopOffer=true, TopOfferFactor=2,GameTime=DateTime.Now},
                ...
                new SportGame{ Team1="Zaballos H.",Team2="Djere L.", CategoryId=context.SportCategorys.Where(x=>x.CategoryName=="Tenis").First().Id,Value1=2.40,Value2=1.50 ,ValueX=1,Value12=1,Value1X=1,Value2X=1,TopOffer=true, TopOfferFactor=2,GameTime=DateTime.Now},
                ...
                new SportGame{ Team1="Roma",Team2="Porto", CategoryId=context.SportCategorys.Where(x=>x.CategoryName=="Soccer").First().Id,Value1=2.10,Value2=3.60 ,ValueX=3.40,Value12=1.33,Value1X=1.30,Value2X=1.75,TopOffer=true, TopOfferFactor=2,GameTime=DateTime.Now},
                ...
                new SportGame{ Team1="Liverpool",Team2="Bayern", CategoryId=context.SportCategorys.Where(x=>x.CategoryName=="Soccer").First().Id,Value1=1.7,Value2=2.25 ,ValueX=1.50,Value12=1,Value1X=1.50,Value2X=1.92,TopOffer=true, TopOfferFactor=2,GameTime=DateTime.Now},
